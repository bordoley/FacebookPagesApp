...
{
    public interface INewPostViewModel : INavigationModel, IActivationViewModel
    {
    ...
    public interface INewPostControllerModel : INavigationModel, IActivationControllerModel
    {
