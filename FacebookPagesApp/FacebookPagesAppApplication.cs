...
{
    [Application]
    public sealed class FacebookPagesAppApplicationApplication : RxApplication
    {
        private readonly FacebookPagesAppApplicationController applicationController;

        public FacebookPagesAppApplicationApplication(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
            applicationController = new FacebookPagesAppApplicationController(this.NavigationStack);
        }
