...
{
    public interface IPagesViewModel : INavigationModel, IActivationViewModel
    {
    ...
    public interface IPagesControllerModel : INavigationModel, IActivationControllerModel
    {
